...
from MRT_SVI_functions import _fit_single_document
...
class MRT_SVI(object):
    def __init__(self, K, G, A):
        ...
        self.eta = latentVariableGlobal()                       # topic-emotion distribution [self.A, self.G, self.E]
        ...
        self.GLV = {"theta": None, "pi": None, "eta": None, "phi": None, "psi": None}
    ...
    def fit(self, dataDUE, dataDUE_valid_on_shell=None, dataDUE_valid_off_shell=None,
            alpha=0.1, beta=0.01, gamma=1000, delta=0.001, zeta=0.01, max_iter=500, resume=None,
        ...
        self._setHyperparameters(alpha, beta, gamma, delta, zeta, lr_tau, lr_kappa, lr_init, converge_threshold_inner)
    ...
    def _setHyperparameters(self, alpha, beta, gamma, delta, zeta, lr_tau, lr_kappa, lr_init, converge_threshold_inner):
    ...
    def _fit_batchIntermediateInitialize(self):
        ...
        vars = {
            ...
            "TF": np.zeros([self.K, self.A], dtype=np.float64),
    ...
    def _fit_single_batch_cumulate(self, returned_fit_single_document, var_temp):
        ...
        d, doc_z, doc_f, doc_u, doc_x, doc_TV, doc_FXE, doc_TF = returned_fit_single_document  # parse returned from self._fit_single_document
    ...
    def _fit_single_batch_global_update(self, var_temp, batch_size_real, epoch):
        ...
        new_pi_temp = self.delta + batch_weight * var_temp["TF"]
